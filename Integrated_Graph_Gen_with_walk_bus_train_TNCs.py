...
from mrt_graph_functions_with_hist_tt_new_where_tt_is_dt_diff import gen_train_station_nodes, gen_train_route_nodes, gen_train_route_edges, gen_depart_and_arrival_timetable_data, gen_train_route_edge_tt, add_static_tt_to_missing_edge_tt, assign_route_edge_dep_timetable, gen_train_platform_transfer_edges, gen_assign_train_route_edge_distances, gen_assign_train_edge_distance_based_cost, gen_assign_train_edge_zone_to_zone_cost, assign_train_station_access_nodes
from bus_graph_gen_funct_with_hist_tt_new_where_tt_is_dt_diff import gen_bus_stop_nodes, gen_bus_route_nodes, gen_bus_route_edges, gen_bus_dep_arr_timetable, gen_bus_route_edge_tt, gen_bus_route_node_transfer_edges, assign_bus_stop_access_nodes, assign_bus_edge_dep_timetable, gen_assign_bus_edge_zone_to_zone_cost, gen_assign_bus_route_edge_distances, gen_assign_bus_edge_distance_based_cost
...
pareto_paths_with_attrs_backwards_no_len_new_pt, pareto_paths_with_attrs_backwards_no_len_all_dp
...
print(int_train_bus_walk_graph.number_of_nodes())
print(int_train_bus_walk_graph.number_of_edges())
# i = 0
...
#print(int_train_bus_walk_graph['w19']['w18']['travel_time'])
...
OD_pair = ('w60', 'w64')
request_time_sec = 28800  
start = time.time()
#@profile
#def elamou():
pareto_paths = pareto_paths_with_attrs_backwards_no_len_all_dp(pt_walk_TNCs_cs_graph, OD_pair[0], OD_pair[1], request_time_sec, request_time_sec, 
                                             request_time_sec+3600, 30, travel_time='travel_time', distance='distance', \
...
#
#['w60', 'w52', 'w50', 'w_bus_stop6', 'b6', '6,1_1,4', '9,1_1,5', '11,1_1,6', 'b11', '11,5_2,5', '28,5_2,6', 'b28', '28,3_1,11', \
# '26009,3_1,12', 'b26009', 'w_bus_stop26009', 'w64'], 'optimal_crt_values': (3687, 0.7187, 3, 1)